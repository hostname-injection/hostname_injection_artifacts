...
def test_method_contracts_are_recomputable() -> None:
    ...
    assert report["derived"]["code_path_evidence"]["normalizer_trace_records_url_segments"] is True
    ...
    assert report["derived"]["code_path_evidence"]["explanations_report_family_log_ratio_evidence"] is True
    assert report["derived"]["code_path_evidence"]["explanations_record_threshold_and_score_scope"] is True
    ...
    assert report["derived"]["edit_manifest"]["hex_base_edit_closure"] is True
    ...
    assert report["derived"]["caho_training_support"]["validation_score_source_reported"] is True
    assert report["derived"]["caho_training_support"]["validation_restore_best_state_available"] is True
    ...
    assert report["derived"]["caho_training_support"]["training_hyperparameter_validation_available"] is True
    ...
    assert report["derived"]["bundle_contracts"]["load_rejects_invalid_scoring_config"] is True
    assert report["derived"]["bundle_contracts"]["save_rejects_invalid_scoring_config"] is True
