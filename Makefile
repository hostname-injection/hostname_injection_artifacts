...
CHECKPOINT ?= caho_model_checkpoint
PER_CLASS ?= 50
BATCH ?= 128
BASELINES ?=
...
train-caho-corpus:
	python -m ccd.cli train-caho-corpus --benign-dir txt_corpus/benign --malicious-jsonl-dir filtered_corpus --malicious-txt-dir txt_corpus/varied --out caho_model_checkpoint
